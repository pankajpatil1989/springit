...
import com.pankaj.springit.service.CommentService;
import com.pankaj.springit.service.LinkService;
...
public class LinkController {
    ...
    public String createLink(@Valid Link link, BindingResult bindingResult, Model model, RedirectAttributes redirectAttributes) {
        if(bindingResult.hasErrors()) {
            logger.info("Validation error were found while submitting new link.");
            model.addAttribute("link",link);
            return "/link/submit";
        } else {
            // save our link
            linkService.save(link);
            logger.info("New link save successfully.");
